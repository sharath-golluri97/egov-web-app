...
var StatusIcon = function StatusIcon(_ref) {
  ...
  switch (status) {
    ...
    case "resolved":
      return _react2.default.createElement(_components.Icon, { action: "action", name: "done", style: statusResolvedIconStyle, color: "#FFFFFF" });
    case "closed":
      return _react2.default.createElement(_components.Icon, { action: "action", name: "stars", style: statusResolvedIconStyle, color: "#FFFFFF" });
  }
};
